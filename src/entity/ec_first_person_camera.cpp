...
namespace entity {
    ...
    void ECFirstPersonCamera::position_camera() {
        ...
        global.application->engine()->game()->active_scene()->camera().transform.pos = entity_transform.pos;
    }
    ...
    void ECFirstPersonCamera::on_rotation_change(RotationChangeEvent event) {
        ...
        global.application->engine()->game()->active_scene()->camera().transform.rotation().set_rotation(event.rotation);
    }
}